...
export const Header = ({inputChangeHandler, restoreHidden, sortTicketsByDate, sortByContentLength, completedTickets, setCompletedTickets, getCompletedTicket, setTicketUnDone, hiddenTickets, ticketsData }) => {
    return (
        <div id="mainHeader">
            ...
            <div className="availableTickets">Available Ticket = {ticketsData.length}</div>
