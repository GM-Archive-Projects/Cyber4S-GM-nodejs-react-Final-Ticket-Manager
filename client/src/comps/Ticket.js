...
const Ticket = ({
  ticket, hideTicketsHandler, setTicketUnDone, setTicketDone, getDate, progress, setProgress,
}) =>
// const [doShow, setDoShow] = useState(false)
  (
    <div className="ticket">
      ...
      <Button className="changeTicketState" variant={ticket.done ? 'success' : 'danger'} onClick={ticket.done ? () => setTicketUnDone(ticket) : () => setTicketDone(ticket)}>
        {' '}
